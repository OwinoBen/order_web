...
$(document).ready(function () {
        ...
        if (keyword.length >= 2) {
            searchAjaxCall = $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.data != 0) {
                        $("#search_box_main_div").append(response.html).show();
                    } else {
    ...
    window.placeOrderBeforePayment = function placeOrderBeforePayment(address_id = 0, payment_option_id, tip = 0) {
        console.log('hello placeOrderBeforePayment ')
        var task_type = $("input[name='task_type']").val();
        var schedule_dt = $("#schedule_datetime").val();
        var slot = $("#slot").val();
        var is_gift = $('#is_gift:checked').val() ?? 0;
    ...
    $(document).on("click", ".proceed_to_pay", function () {
        ...
        if (payment_option_id == 1 || payment_option_id == 38 || post_pay_edit_order == 1) {
            console.log('inside if placeorder custom')
    ...
    $(document).on("click", ".topup_wallet_confirm", function () {
        ...
        // if(payment_option_id == 60){
        //     console.log('wallleeet');
        //     var wallet_amount = $('#wallet_amount').val();
...
//    cartHeader();
        ...
        switch (action) {
          ...
          case '53':
            ...
            case '60':
              ...
              if (order != '') {
                console.log('case');
                payWithSasaPay(payment_option_id, order);
              }
            break;
        }
    ...
    function walletPaymentOPtions(payment_option_id)
    {
        switch (payment_option_id) {
            ...
            case 60:
                payWithSasaPay(payment_option_id,'');
            break;
        }
    }
...
$(".related-css").slick({dots:!1,infinite:!0,speed:300,slidesToShow:6,centerPadding:"20px",slidesToScroll:4,arrows:!0,responsive:[{breakpoint:1200,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:991,settings:{slidesToShow:2,arrows:!0,slidesToScroll:2}},{breakpoint:767,settings:{slidesToShow:2,arrows:!0,slidesToScroll:2}}]});
