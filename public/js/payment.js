...
/////////////////////////////////////////////Paytab Pamyent Gateway /////////////////////////////////////////
    ...
    window.creditCardValidation =  function creditCardValidation()
   {
        ...
        window.payWithSasaPay = function payWithSasaPay(payment_option_id,order) {
            console.log('errrorr');
            let tip = 0;
            let tipElement = $("#cart_tip_amount");
            let cartElement = $("input[name='cart_total_payable_amount']");
            ...
            data.payment_option_id = payment_option_id;
            data._token = $('input[name=_token]').val();
            // $.redirect(sasapay_before_payment, data);
        
            
            $.ajax({
                type: "post",
                dataType: "json",
                url: sasa_payment_url,
                data: data,
        
                success: function (response) {
                    if(response.status == true){
                        console.log('Truee yooooooooooooooooooo')
                    }
                }
            });
        }
