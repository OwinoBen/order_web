...
!(async function (e) {
    ...
    var sliderConfigEight10 = {
        ...
        responsive: [
            ...
            { breakpoint: 1530, settings: { slidesToShow: 5, slidesToScroll: 3 } },
            { breakpoint:  991, settings: { slidesToShow: 2, slidesToScroll: 2 } },
            { breakpoint:  400, settings: { slidesToShow: 2, slidesToScroll: 1 } },
        ],
    };
    ...
    var sliderConfigEight = {
        ...
        responsive: [
            { breakpoint: 1920, settings: { slidesToShow: 6, slidesToScroll: 2 } },
            { breakpoint: 1530, settings: { slidesToShow: 5, slidesToScroll: 2 } },
            { breakpoint:  991, settings: { slidesToShow: 2, slidesToScroll: 2 } },
            { breakpoint:  480, settings: { slidesToShow: 2, slidesToScroll: 1 } },
        ],
    };
    var sliderConfigEight1 = {
        rows: 1,
		dots: false,
		arrows: true,
		infinite: true,
        ...
        responsive: [            
            ...
            { breakpoint:  991, settings: { slidesToShow: 2, slidesToScroll: 1,  centerPadding: '0' } },
            { breakpoint:  480, settings: { slidesToShow: 2, slidesToScroll: 1,  centerPadding: '0' } },
        ],
    };
    ...
    if (
        ...
        e(".on_sale_slider ").slick(sliderConfigEight1),
...
body_event.on("click", ".theme-layout-version", function () {
    ...
    $(".item_row").click(function(){
        $(".margin-res").addClass("list_style");
      });
      $(".item_grid").click(function(){
        $(".margin-res").removeClass("list_style");
      });
