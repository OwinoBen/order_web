...
<link defer type="text/css" rel="stylesheet"  href="{{asset('frontend/template_ten/header/header.css')}}">
<link defer type="text/css" rel="stylesheet"  href="{{asset('frontend/template_ten/footer/footer.css')}}">
<link defer type="text/css" rel="stylesheet"  href="{{asset('frontend/template_ten/tentemplate.css')}}">
	@if(Route::currentRouteName() == "userHome")
	<link defer type="text/css" rel="stylesheet"  href="{{asset('frontend/template_ten/homepage/homepage.css')}}">
	@else
<link defer type="text/css" rel="stylesheet"  href="{{asset('frontend/template_ten/homepage/inner_page.css')}}">
	@endif
	@if(Route::currentRouteName() == "homeTest")
	<link defer type="text/css" rel="stylesheet"  href="{{asset('frontend/template_ten/homepage/homepage.css')}}">
	@else
...
<style type="text/css">
    ...
    :root {--theme-deafult: <?= ($client_preference_detail) ? $client_preference_detail->web_color : '#ff4c3b' ?>;
	--top-header-color: <?= ($client_preference_detail) ? $client_preference_detail->site_top_header_color : '#4c4c4c' ?>;
	--footer_color: <?= ($client_preference_detail) ? $client_preference_detail->footer_color : '#4c4c4c' ?>;
	--alpha: 0.8;
}
