...
<header id="al_new_design" class="site-header @if ($client_preference_detail->business_type == 'taxi') taxi-header @endif">
   ...
   @else
   <div class="d-none main-menu @if((\Request::route()->getName() != 'userHome')) no-category-image @endif" @if ($client_preference_detail->business_type != 'super_app') style="display:none;" @endif>
      ...
      <div class="container">
         <div class="row">
            <div class="col-12 ">
               ...
               <ul class="header-dropdown bottom_bar" style="height:auto;">
