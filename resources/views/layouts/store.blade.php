...
if(isset($set_template))
{
  ...
  switch($selectedTemplate) {
    ...
    $footer_content = 'layouts.store/footer-content-template-one';
      ...
      case 10:
      $body_class = "al_body_template_ten p2p-module";
      $left_sidebar = 'layouts.store/left-sidebar-template-ten';
      $footer_content = 'layouts.store/footer-content-template-ten';  
      break;
    default:
      $body_class = "al_body_template_one";
