...
<div class="web-style col-12">
    ...
    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-6  mb-3">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" id="footer_color" name="footer_color" class="form-control ss_form_submit" value="{{ old('footer_color', $client_preferences->footer_color ?? '#000')}}">
                                    </div>
                                </div>
        ...
        <div class="col-md-3 h-100">
            <form method="POST" action="{{route('web-styling-top-bar-text.update', $topBarText->id ?? 0)}}" enctype='multipart/form-data'>
                @csrf
                @method('put')
                <div class="row h-100">
                    <div class="col-12">
                        <div class="card-box">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h4 class="header-title mb-0">{{ __("Top Bar Text") }}</h4>
                                <button class="btn btn-info d-block" type="submit"> {{ __("Save") }} </button>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        <label for="contact_address">{{ __("banner Image") }}</label>
                                        <div class="input-group">
                                        <input type="file" accept="image/*" data-default-file="{{get_file_path(@$topBarText->banner_image, 'IMG_URL1', '400', '150') }}" data-plugins="dropify" name="banner_image" class="dropify" id="image"/>
                                        </div>
                                    ...
                                    <div class="form-group mb-1">
                                        <label for="contact_address">{{ __("Bold Text") }}</label>
                                        <div class="input-group">
                                            <input type="text" name="bold_text" id="bold_text"  class="form-control" value="{{ old('bold_text', strtoupper(@$topBarText->bold_text) ?? '')}}">
                                        </div>
                                        @if($errors->has('bold_text'))
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $errors->first('bold_text') }}</strong>
                                        </span>
                                        @endif
                                    </div>
                                    <div class="form-group mb-1">
                                        <label for="contact_address">{{ __("Normal Text") }}</label>
                                        <div class="input-group">
                                            <input type="text" name="normal_text" id="normal_text"  class="form-control" value="{{ old('normal_text', ucwords(@$topBarText->normal_text) ?? '')}}">
                                        </div>
                                        @if($errors->has('normal_text'))
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $errors->first('normal_text') }}</strong>
                                        </span>
                                        @endif
                                    </div>

                                    <div class="form-group mb-1">
                                        <label for="contact_address">{{ __("Assign To") }}</label>
                                        <select class="selectize-select form-control assignToSelect" name="assignTo">
                                            <option value="">{{ __("Select") }}</option>
                                            <option value="category" {{($topBarText->link == 'category') ? 'selected' : ''}}>{{ __('Category') }}</option>
                                            <option value="vendor" {{($topBarText->link == 'vendor') ? 'selected' : ''}}>{{ __("Vendor") }}</option>
                                        </select>
                                        @if($errors->has('normal_text'))
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $errors->first('normal_text') }}</strong>
                                    ...
                                    <div class="form-group mb-1 category_list" style="{{($topBarText->link == 'category') ? '' : 'display: none;'}}">
                                        <label for="contact_address">{{ __("Select Category") }}</label>
                                        <select class="selectize-select form-control" name="category_id">
                                            <option value="">{{ __("Select Category") }}...</option>
                                            @foreach($categories as $category)
                                            <option value="{{$category->id}}" @if(@$topBarText->redirect_category_id == $category->id) selected="selected" @endif>
                                    ...
                                    <div class="form-group mb-1 vendor_list" style="{{($topBarText->link == 'vendor') ? '' : 'display: none;'}}">
                                        <label for="contact_address">{{ __("Select Vendor") }}</label>
                                        <select class="selectize-select form-control" name="vendor_id">
                                            <option value="">Select</option>
                                            @foreach($vendors as $key => $vend)
                                                <option value="{{$vend->id}}" {{($vend->id == $topBarText->redirect_vendor_id) ? 'selected' : ''}}>{{$vend->name}}</option>
                                            @endforeach
                                        </select>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var color1 = new jscolor('#footer_color', options);
    });
