...
<div class="container-fluid right-side-banner">

    <!-- start page title -->
    <div class="row align-items-center">
        <div class="col-sm-12">
            <div class="page-title-box d-flex justify-content-between align-items-center">
                <h4 class="page-title">{{ __('Right Side Banner') }}</h4>
                <button class="btn btn-info waves-effect waves-light text-sm-right rightSideBanner"
                userId="{{$rightSideBanner->id ?? 0}}"><i class="mdi mdi-plus-circle mr-1"></i> {{ __('Add') }}
            </button>
            </div>
        </div>
    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-centered table-nowrap table-striped" id="banner-datatable">
                                        ...
                                        <tbody id="post_list">
                                            <tr data-row-id="{{$rightSideBanner->id}}">
                                                <td class="banner_wrapper">
                                                    <div class="banner_box">
                                                        <img src="{{$rightSideBanner->image['proxy_url'].'400/160'.$rightSideBanner->image['image_path']}}" alt="{{$rightSideBanner->id}}" >
                                                    </div>
                                                </td>

                                                <td><a class="rightSideBanner" userId="{{$rightSideBanner->id}}" href="#"> {{ $rightSideBanner->name }}</a> </td>
                                                <td> <span class="text-center d-inline-block">
                                                    @if(isset($rightSideBanner->start_date_time) && isset($rightSideBanner->end_date_time))
                                                    {{ dateTimeInUserTimeZone($rightSideBanner->start_date_time, $timezone)}} <br/> to <br/> {{dateTimeInUserTimeZone($rightSideBanner->end_date_time, $timezone)}}
                                                    @else
                                                    -
                                                    @endif
                                                </span></td>
