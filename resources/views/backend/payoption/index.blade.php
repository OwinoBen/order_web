    ...
    <form method="POST" id="payment_option_form" action="{{route('payoption.updateAll')}}"  enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-3 col-xl-2 mb-3" id="payment_{{$opt->id}}">
				...
				$sasapay_client_id = (isset($creds->sasapay_client_id)) ? $creds->sasapay_client_id : '';
				$sasapay_client_key = (isset($creds->sasapay_client_key)) ? $creds->sasapay_client_key : '';
                ...
                <div class="card-box h-100 mb-0">
					...
					@if ( (strtolower($opt->code) == 'sasapay') )
						<div class="mt-2" id="sasapay_fields_wrapper" @if($opt->status != 1) style="display:none" @endif>
							<div class="row">
								<div class="col-12">
									<div class="form-group mb-2">
										<label for="sasapay_merchant" class="mr-3">{{ __("Client Id") }}</label> <input type="text" name="sasapay_client_id"
											id="sasapay_client_id" class="form-control"
											value="{{$sasapay_client_id}}" @if($opt->status == 1) required
										@endif>
									</div>
								</div>
								<div class="col-12">
									<div class="form-group mb-2">
										<label for="sasapay_client_key" class="mr-3">{{ __("Client Secret") }}</label> <input type="text"
											name="sasapay_client_key" id="sasapay_client_key"
											class="form-control" value="{{$sasapay_client_key}}" @if($opt->status == 1) required @endif>
									</div>
								</div>
