...
body.al_body_template_ten  section.wrapper-main form#login-form-new span.fa.fa-eye-slash.toggle-password {
...
form#login-form-new , p.login_disc{
    padding: 0 20px;
}
}
.dark .offset-xl-2 p {
...
<section class="wrapper-main  d-flex align-items-center">
    <div class="container-full w-100">
        <div class="row align-items-center h-100" id="login-section">
            ...
            <div class="col-md-12 col-lg-6 mb-lg-0 mb-3 text-center pb-sm-0 {{(@$getAdditionalPreference['is_phone_signup'] == 1) ? 'offset-lg-3' : ' ' }}">
                <div class="img">
                ...
                <h3 class="login_title mb-2">{{ __('Welcome Back') }}</h3>
                <p class="login_disc">Login to your account to access all the products offered by us.</p>
                ...
                <div class="row mt-3 arabic-language">
                    <div class="offset-xl-2 col-xl-8 text-left">
                        ...
                        <div class="login-with-username">
                            ...
                            <div class="form-group" id="password-wrapper" style=" position:relative">
                            ...
                            <div class="form-group">
                                <button class="btn btn-solid w-100 login_continue_btn" type="submit">{{__('Login')}}</button>
                            </div>
                        </div>
                        </form>
                        <p class="text-center">Dont’ have an account?  <a href="{{route('customer.register')}}"> Signup</a></p>
                    </div>
                </div>
                <div class="col-md-12">
