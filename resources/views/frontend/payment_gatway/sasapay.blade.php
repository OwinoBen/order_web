...
<body>
  ...
  <form class="al_payment_gatewayForm" id="sasa-payment-form" action="{{route('payment.sasapay.createPayment')}}" method="POST">
  ...
  <script type="text/javascript">
    ...
    braintree.dropin.create({
      authorization: "OfSxjwdmXBXs4Jeu7hYJAXaC0Zag79kzTlWnuWo5",
