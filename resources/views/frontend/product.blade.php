                ...
                <div class="col-sm-12">
                    <div class="container-fluid">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="@php if(!empty($product->media) && count($product->media) > 0){ echo 'col-lg-5'; } else { echo 'col-lg-5'; } @endphp rtl-text">
                                                            ...
                                                            <label class="radio d-inline-block txt-14 col-4 position-relative pl-4 pr-2">{{$optn->title}}
                                                                @if($variant->type == 2)
                                                                    ...
                                                                    <span class="color_var radio_var radio_{{$var_id}}" style="padding:8px; border: 1px dotted #CCC; background:#fff;" data-id="{{$var_id}}"></span>
                                                               	 	@endif
                                                                <input id="lineRadio-{{$opt_id}}" name="{{'var_'.$var_id}}" vid="{{$var_id}}" optid="{{$opt_id}}" value="{{$opt_id}}" type="radio" class="changeVariant dataVar{{$var_id}}" {{$checked}} data-cartCheck="{{(($checkSlot == 0  && $vendor_info->is_vendor_closed == 1) ||  ($optn->quantity < $product->minimum_order_count)) ? 1 : 0}}">
                                ...
                                <div id="product_variant_quantity_wrapper" class="mt-3 pl-sm-3">
                                    @if($product->inquiry_only == 0)
