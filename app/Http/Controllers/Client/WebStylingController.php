...
use App\Models\{ClientPreference, PaymentMethod,HomePageLabel,ClientLanguage, HomePageLabelTranslation,CabBookingLayout,CabBookingLayoutTranslation,Category,CabBookingLayoutCategory, ClientPreferenceAdditional,OrderDeliveryStatusIcon, WebStyling,WebStylingOption, HomeProduct, Product, CabBookingLayoutBanner, TopBarText, Vendor};
    ...
    public function updateWebStyles(Request $request){
        ...
        if($client_preferences){
           ...
           // $client_preferences->show_payment_icons = $request->show_payment_icons == 'on' ? 1 : 0;
            ...
            $client_preferences->footer_color = $request->footer_color;
