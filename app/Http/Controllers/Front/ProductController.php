...
class ProductController extends FrontController{
    ...
    public function index(Request $request, $domain = '',$vendor,$url_slug){
        ...
        if(isset($product->category) && isset($product->category->categoryDetail) &&  in_array($product->category->categoryDetail->type_id ,[8,12])  && $product->is_recurring_booking !=1){ // onDemand and appointent
