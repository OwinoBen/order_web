...
class InfluencerReferAndEarnController extends FrontController
{
    use InfluencerTrait;
    function index(Request $request) {
        ...
        return view('frontend/account/referAndEarn')->with(['influencer_category' => $influencer_category, 'influencer_user' => $influencer_user, 'order_user_promo_product' => $order_user_promo_product,'navCategories'=>$navCategories]);
    }
    ...
    function getReferEarnForm(Request $request, $domain, $id) {
        ...
        return view('frontend/account/referAndEarnForm')->with(['productAttributes' => $productAttributes, 'influencer_category' => $influencer_category,'navCategories'=>$navCategories]);
    }
