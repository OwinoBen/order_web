...
use App\Http\Controllers\Front\{SasaPayController, FrontController, CashfreeGatewayController,EasebuzzController,VnpayController, PayUGatewayController, MyCashGatewayController,UseRedePaymentController,OpenpayPaymentController};
...
class PaymentController extends FrontController{
    ...
    public function postPaymentVia_sasapay(Request $request){
        $gateway = new SasaPayController();
