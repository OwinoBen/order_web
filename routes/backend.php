...
Route::group(['middleware' => 'adminLanguageSwitch'], function () {
    Route::group(['middleware' => ['ClientAuth', 'database','permission'], 'prefix' => '/client'], function () {
        ...
        Route::resource('web-styling-top-bar-text', "Client\TopBarTextController");
        ...
        Route::get('vendors/export/{id}', 'Client\VendorController@vendorProductExport')->name('vendor.product.export');
